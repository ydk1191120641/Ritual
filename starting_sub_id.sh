...
sed -i 's|"rpc_url": ".*"|"rpc_url": "https://base.llamarpc.com"|' /root/infernet-container-starter/deploy/config.json
sed -i 's|"rpc_url": ".*"|"rpc_url": "https://base.llamarpc.com"|' /root/infernet-container-starter/projects/hello-world/container/config.json
