...
sed -i "s|\"starting_sub_id\": [0-9]\+\(\.[0-9]\+\)\?|\"starting_sub_id\": 250000|" /root/infernet-container-starter/deploy/config.json
sed -i "s|\"starting_sub_id\": [0-9]\+\(\.[0-9]\+\)\?|\"starting_sub_id\": 250000|" /root/infernet-container-starter/projects/hello-world/container/config.json
